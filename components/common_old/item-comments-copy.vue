    ...
    <div class="defect_block">
        ...
        <div v-if="modal.comment_list.visible" class="modal-wrapper">
            <div class="modal-block new_task_modal">
                ...
                <div class="insblock_content">
                    <div class="comment_area" v-for="comment in data.item.comments" v-bind:key="comment.id">
                        <div class="comment_row">
                            ...
                            <span class="comment_text">{{comment.примечание}}</span>
                        </div>
                ...
                <button class="button button-cancel" v-on:click="hide_comments">Назад</button>
        ...
        <div v-if="modal.create_comment.visible" class="modal-wrapper">
            <div class="modal-block new_task_modal">
                ...
                <div v-on:click="production_defect_add_attachment(data.item)" class="attach_file_modal">
                    ...
                    <button class="button_sheet">Прикрепить файл</button>	
                </div>
...
/* КОМПОНЕНТ ПОЗВОЛЯЕТ ДОБАВИТЬ И ПРОСМОТРЕТЬ ЗАМЕЧАНИЯ ПО ИЗДЕЛИЮ
    НЕОБХОДИМО ИМЕТЬ ДАННЫЕ(В PHP ЗАПРОСЕ) ПО НАЛИЧИЮ ЗАМЕТОК ДЛЯ ОТОБРАЖЕНИЯ В КОМПОНЕНТЕ ВЛОЖЕНИЙ НАЛИЧИЕ ФАЙЛОВ
...
*/
    ...
    module.exports = {
        ...
        components: {
        'my-modal-alert': httpVueLoader('/crm/frontend/components/common_old/my-modal-alert.vue?t=' + new Date()),
                ...
                axios
                    ...
                    .then(function (response) {
                        ...
                        if(response.data.result == '-ok'){
                            ...
                            show_alert('Замечание добавлена')
                            hide_create(item)
                        }else{
